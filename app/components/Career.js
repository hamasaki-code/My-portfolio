    ...
    <section id="career" className="my-16 scroll-mt-24">
      ...
      <div className="relative border-l-4 border-gray-300 dark:border-gray-700 ml-4">
        ...
        <div className="mb-10 ml-8">
          <div className="absolute flex items-center justify-center w-6 h-6 bg-indigo-500 dark:bg-indigo-400 rounded-full -left-3 ring-4 ring-white dark:ring-gray-900">
        ...
        {/* 2つ目の経験 */}
        <div className="mb-10 ml-8">
          <div className="absolute flex items-center justify-center w-6 h-6 bg-gray-400 dark:bg-gray-600 rounded-full -left-3">
            <FaLaptopCode className="w-3 h-3 text-white" />
          </div>
          <time className="inline-block text-xs font-semibold tracking-wide uppercase text-neutral-700 bg-neutral-100 dark:text-neutral-100 dark:bg-neutral-700 px-3 py-0.5 rounded-full mb-2">
            2025年5月 - 2025年7月
          </time>
        ...
        <div className="mb-10 ml-8">
          <div className="absolute flex items-center justify-center w-6 h-6 bg-gray-400 dark:bg-gray-600 rounded-full -left-3">
            <FaUniversity className="w-3 h-3 text-white" />
          </div>
          <time className="inline-block text-xs font-semibold tracking-wide uppercase text-neutral-700 bg-neutral-100 dark:text-neutral-100 dark:bg-neutral-700 px-3 py-0.5 rounded-full mb-2">
            2020年4月 - 2024年3月
          </time>
        ...
        <div className="mb-10 ml-8">
          <div className="absolute flex items-center justify-center w-4 h-4 bg-gray-400 dark:bg-gray-600 rounded-full -left-2">
            <FaBriefcase className="w-2 h-2 text-white" />
          </div>
          <time className="inline-block text-xs font-semibold tracking-wide uppercase text-neutral-700 bg-neutral-100 dark:text-neutral-100 dark:bg-neutral-700 px-3 py-0.5 rounded-full mb-2">
            2023年6月 - 2024年3月
          </time>
          <h3 className="text-2xl font-bold text-black dark:text-white">株式会社LITALICO</h3>
          <p className="text-base font-semibold text-neutral-600 dark:text-neutral-400 mt-1">
            LITALICOワンダー・セールス
        ...
        <div className="mb-10 ml-8">
          <div className="absolute flex items-center justify-center w-4 h-4 bg-gray-400 dark:bg-gray-600 rounded-full -left-2">
            <FaChalkboardTeacher className="w-2 h-2 text-white" />
          </div>
          <time className="inline-block text-xs font-semibold tracking-wide uppercase text-neutral-700 bg-neutral-100 dark:text-neutral-100 dark:bg-neutral-700 px-3 py-0.5 rounded-full mb-2">
            2021年4月 - 2023年11月
          </time>
          <h3 className="text-2xl font-bold text-black dark:text-white">株式会社インフラトップ</h3>
          <p className="text-base font-semibold text-neutral-600 dark:text-neutral-400 mt-1">
            DMM WEBCAMP・メンター
